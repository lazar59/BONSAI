      ...
      >
        ...
        <div className="navbar-content">
          <div className='logo-img flex flex-col space-y-2 items-center pb-0' style={{ padding: '15px 30px' }}>
            ...
            {/* <span className='fs-24 text-green m-0'>{loading || magicPrice === '' ? <LoadingSkeleton /> : `$${numberWithCommas(magicPrice, 4)}`}</span> */}
            <span className='fs-24 text-green m-0'>$0.03</span>
